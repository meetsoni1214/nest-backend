...
describe('KeyResultService', () => {
    ...
    describe('fetchKeyResult()', () => {
        it('should call findUnique() method of PrismaService', async () => {
            ...
            expect(prismaService.keyResult.findUnique).toHaveBeenCalledWith({"where": {"id": 1}});
        });
    ...
    describe('fetchKeyResults()', () => {
        it('should call findMany() method of PrismaService', async () => {
            ...
            expect(prismaService.keyResult.findMany).toHaveBeenCalledWith({"where": {"objective_id": 1}});
        });
    ...
    describe('createMany()', () => {
        it('should call createMany() method of PrismaService', async () => {
            ...
            expect(prismaService.keyResult.createMany).toHaveBeenCalledWith({"data": keyResultsDto});
        });
    ...
    describe('deleteOne()', () => {
        it('should call delete() method of PrismaService', async () => {
            ...
            expect(prismaService.keyResult.delete).toHaveBeenCalledWith({"where": {"id": 2}})
        });
    ...
    describe('deleteMany()', () => {
        it('should call deleteMany() method of PrismaService', async () => {
            ...
            expect(prismaService.keyResult.deleteMany).toHaveBeenCalledWith({"where": {"objective_id": 1}})
        });
    ...
    describe('update()', () => {
        it('should call update() method of PrismaService', async () => {
            ...
            expect(prismaService.keyResult.update).toHaveBeenCalledWith({"where": {"id": 1}, "data": keyResultsDto[0]});
        });
